...
puts array.find_all.with_index { |_e, i| i < array.index(array.min) }.to_s
puts
puts '– необходимо найти три наименьших элемента;'
puts array.sort { |a, b| a <=> b }.find_all.with_index { |_e, i| i < 3 }.to_s
puts
puts 'Original array: '
puts array.to_s
